  ...
  <div class="bg-white dark:bg-neutral-800 m-2 p-2 rounded-lg drop-shadow">
    ...
    >
      <template #item="{ index, element }">
        <div>
          <div v-if="element.type == 32">
            <div
              class="bg-neutral-200 dark:bg-neutral-700 w-full rounded mb-2 p-1"
            >
              <div class="flex items-center">
                <h1 class="w-full">{{ element.title }}</h1>
                <button
                  class="mx-1 w-28 select-none bg-white dark:bg-neutral-900 dark:text-neutral-200 px-3 py-1 rounded hover:outline hover:outline-2"
                >
                  Add todo
                </button>
                <button
                  class="select-none h-8 aspect-square flex items-center justify-center bg-white dark:bg-neutral-900 p-1 rounded hover:outline hover:outline-2 dark:outline-neutral-200"
              ...
              <div class="ml-3 mt-2" v-for="item in element.list">
                <div class="flex items-center mb-1">
                  <input
                    class="w-full p-1 mr-1 focus:outline-0 rounded dark:text-neutral-200 border border-1 border-neutral-300 outline-neutral-400"
                  ...
                  />
                  <button
                    class="select-none h-8 aspect-square flex items-center justify-center bg-white dark:bg-neutral-900 p-1 mr-1 rounded hover:outline hover:outline-2 dark:outline-neutral-200"
